/*
 * This code is for the controller which takes inputs from
 * multiple drum pads and converts them to midi output,
 * which can then trigger drum sounds in any MIDI sound
 * module.
 * 
 * Based on code by Evan Kale, from his ArduinoMidiDrums project.
 */
